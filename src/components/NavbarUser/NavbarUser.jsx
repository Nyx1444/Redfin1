...
const NavbarUser = () => {
  ...
  const pages = [
    ...
    { id: "open-house-schedule", label: "Open House Schedule", path: "/open-house-schedule" },
    ...
    { id: "owner-dashboard", label: "Owner Dashboard", path: "/owner-dashboard" },
    { id: "notification-settings", label: "Notification Settings", path: "/notification-settings" },
  ...
  return (
    ...
    <div style={styles.container}>
      {pages.map((page) => (
        ...
        >
          {page.label}
          {location.pathname === page.path && <div style={styles.activeIndicator}></div>}
        </Link>
      ))}
    </div>)}
    </>
