      ...
      <div style={uiButtonContainerStyle}>
        <button style={uiButtonStyle}>
          ...
          <svg viewBox="0 0 24 24" width="24" height="24">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.466 4.742a1 1 0 00-1.932.517l2.604 9.715A1 1 0 017.672 16.1L6 15.134a1 1 0 10-1 1.732l4.932 2.848c.325.187.693.286 1.068.286a1 1 0 110 2 4.135 4.135 0 01-2.068-.554L4 18.598a3 3 0 012.593-5.392l-1.99-7.429a3 3 0 015.795-1.553L11.41 8h5.215a4 4 0 013.864 2.966l.343 1.283a13 13 0 01-.793 8.89l-.134.286a1 1 0 11-1.81-.85l.134-.286a11 11 0 00.671-7.523l-.343-1.283A2 2 0 0016.625 10h-4.68l.2.741a1 1 0 01-1.932.518L8.466 4.742zM12 3a1 1 0 011-1c3.064 0 5.951.766 8.479 2.118a1 1 0 11-.944 1.764A15.925 15.925 0 0013 4a1 1 0 01-1-1z"></path>          </svg>
          <span>Draw</span>
        </button>
        <button style={uiButtonStyle}>
          {/* ไอคอนสำหรับ Options */}
        ...
        <button style={uiButtonStyle}>
          {/* ไอคอนสำหรับ Map */}
          <svg viewBox="0 0 24 24" width="24" height="24">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.233 10.076A8.001 8.001 0 0011 19.938v-.466a1 1 0 00-.106-.447l-.472-.944A4 4 0 0110 16.29V15.5h-.167a2 2 0 01-1.2-.4l-1.605-1.204a2 2 0 01-.439-.453l-2.356-3.367zM14.5 4.398V5.5A2.5 2.5 0 0112 8a.5.5 0 00-.5.5A2.5 2.5 0 019 11a.5.5 0 00-.5.5v1l1.333 1h4a2.667 2.667 0 012.662 2.5h2.435A8.004 8.004 0 0014.5 4.398zm5.914 13.009A9.953 9.953 0 0022 12c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10a9.989 9.989 0 008.226-4.313 1 1 0 00.188-.28z"></path>
          </svg>
          <span>Map</span>
        </button>
      </div>
