...
const StatusFilter = ({ onFilterChange }) => {
    ...
    return (
        <div ref={dropdownRef} style={{ ...styles.fontGlobal, position: 'relative', display: 'inline-block' }}>
            <button
                style={{
            ...
            {isOpen && (
                <div style={styles.filterDropdownDropdown}>
                    <div>
                        <div style={styles.sectionHeader} onClick={() => toggleSection('forSale')}>
                            <div
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...styles.radioButton,
                                        ...(selectedFilter === 'For sale' ? styles.radioChecked : styles.radioUnchecked),
                                    }}
                                >
                                    {selectedFilter === 'For sale' && <div style={styles.radioInnerCircle} />}
                                </div>
                                <label htmlFor="forSale" style={{ marginLeft: '8px', fontSize: '16px' }}>
                                    For sale
                                </label>
                            </div>
                            {expanded.forSale ? (
                            ...
                            <div style={{ marginLeft: '24px', marginTop: '8px' }}>
                                {Object.entries(subFilters).map(([key, value]) => (
                                    <div
                                        ...
                                        onClick={() => setSubFilters({ ...subFilters, [key]: !value })}
                                    >
                                        <input
                                            type="checkbox"
                                            id={key}
                                            checked={value}
                                            onChange={() => setSubFilters({ ...subFilters, [key]: !value })}
                                            style={styles.hiddenInput}
                                        />
                                        <div
                                            style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }} onClick={() => {
                        ...
                        <div
                            style={{
                                ...styles.radioButton,
                                ...(selectedFilter === 'For rent' ? styles.radioChecked : styles.radioUnchecked),
                            }}
                        >
                            {selectedFilter === 'For rent' && <div style={styles.radioInnerCircle} />}
                        </div>
                        <label htmlFor="forRent" style={{ marginLeft: '8px', fontSize: '16px' }}>
                            For rent
                        </label>
                    </div>
                    ...
                    <div>
                        <div style={styles.sectionHeader} onClick={() => toggleSection('sold')}>
                            <div
                                style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}
                                onClick={() => {
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...styles.radioButton,
                                        ...(selectedFilter === 'Sold' ? styles.radioChecked : styles.radioUnchecked),
                                    }}
                                >
                                    {selectedFilter === 'Sold' && <div style={styles.radioInnerCircle} />}
                                </div>
                                <label htmlFor="sold" style={{ marginLeft: '8px', fontSize: '16px' }}>
                                    Sold
                                </label>
                            </div>
                            {expanded.sold ? (
                        ...
                        {expanded.sold && (
                            <div style={{ marginLeft: '24px', marginTop: '8px' }}>
                                {['Last 1 week', 'Last 1 month', 'Last 3 months', 'Last 6 months', 'Last 1 year', 'Last 2 years', 'Last 3 years'].map((timeframe) => (
                                    <div
                                        key={timeframe}
                                        style={{ display: 'flex', alignItems: 'center', cursor: 'pointer', marginBottom: '10px' }}
                                    ...
                                    >
                                        ...
                                        <div
                                            style={{
                                                ...styles.radioButton,
                                                ...(soldTimeframe === timeframe ? styles.radioChecked : styles.radioUnchecked),
                                            }}
                                        >
                                            {soldTimeframe === timeframe && <div style={styles.radioInnerCircle} />}
                                        </div>
