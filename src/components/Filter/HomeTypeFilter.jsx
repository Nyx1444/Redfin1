        ...
        },
        {
            ...
            icon: (isSelected, isHovered) => (
                <svg
                    ...
                    viewBox="0 0 24 24">
                    <path d="M7 9a1 1 0 100 2h3a1 1 0 100-2H7zM7 13a1 1 0 100 2h3a1 1 0 100-2H7zM7 17a1 1 0 100 2h3a1 1 0 100-2H7z">
                    </path>
                    <path
                        d="M4.683 1.548A2 2 0 002 3.428V21a2 2 0 002 2h16a2 2 0 002-2V11a2 2 0 00-2-2h-5V6.7a2 2 0 00-1.316-1.88l-9-3.272zM15 17v-2h2a1 1 0 100-2h-2v-2h5v10h-5v-2h2a1 1 0 100-2h-2zM13 6.7V21H4V3.428L13 6.7z">
                    </path>
                </svg>
            ),
        },
            ...
            {isOpen && (
                <div style={styles.dropdown}>
                    <div style={styles.gridContainer}>
                        {homeTypes.map((item) => (
                            <div
                                ...
                                style={{
                                    ...styles.item,
                                    ...(selectedTypes.includes(item.key) ? styles.selectedItem : {}),
                            ...
                            >
                                {item.icon(selectedTypes.includes(item.key), hoveredType === item.key)}
                                <span
                                    style={{
                                        ...styles.label,
                                        ...(selectedTypes.includes(item.key) ? styles.selectedLabel : {}),
                    ...
                    <div style={styles.buttonRow}>
                        <button style={{
                            ...styles.resetButton,
                            ...(isResetHovered ? { backgroundColor: "rgba(21, 114, 122, 0.2)" } : {}),
                        }}
