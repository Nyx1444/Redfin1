...
const PropertyHeader = ({ displayedProperties, onSortChange, onViewChange }) => {
            ...
            {!isTablet ? (
                <div style={styles.desktopRow}>
                    <h1 style={styles.title}>
                        {searchQuery ? `${searchQuery}, IL homes for sale & real estate` : "All Homes"}
                    </h1>
                    <div style={styles.rightContainer}>
                        <span style={styles.count}>
                            <b>{displayedProperties.length}</b> of <b>{properties.length} homes</b>
                        </span>
                        <span style={styles.sort}>
                            <b>Sort:</b>
                            <div style={styles.selectContainer}>
                                <select style={styles.dropdown} value={selectedSort} onChange={handleSortChange}>
                        ...
                        <span style={styles.view}>
                            <b>View:</b>
                            <div style={styles.selectContainer}>
                                <select style={styles.dropdown} value={selectedView} onChange={handleViewChange}>
