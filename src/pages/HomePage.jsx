    ...
    <div className="search-tab">
      <div className="overlay">
        ...
        <div className="search-bar">
          <input type="text" className="search-input" placeholder="City, Address, School, Agent, ZIP" />
    ...
    <div className="app-section">
      <div className="app-download">
        <div className="app-download-content">
          ...
          <p>Download our top-rated real estate app for iOS or Android to get alerts when your dream home hits the market.</p>
        </div>
      ...
      <div className="tour-section">
        ...
        <div className="tour-content">
          ...
          <p>Unlike many other agents, Redfin agents won’t ask you to sign an exclusive commitment before they’ll take you on a first tour.</p>
