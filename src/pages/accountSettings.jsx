    ...
    return (
        <>
            ...
            <div style={{ ...styles.wrapper, margin: isMobileView ? '0 16px' : '0 140px' }}>
                        ...
                        <div style={styles.alertContent}>
                            ...
                            <div style={{
                                ...
                                <span style={styles.alertText}>
                                    Local MLS rules require you to verify your email address before you can see all home details.
                                </span>
                                <span style={styles.alertLinks}>
                                    <a href="#verify" style={styles.alertLink}>Go to Email</a>
                                    <span> • </span>
                                    <a href="#resend" style={styles.alertLink}>Resend Email</a>
                                </span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style={{
                            ...
                            <div style={styles.formGroup}>
                                ...
                                <div style={{
                                    ...
                                    flexDirection: isMobileView ? 'column' : 'row',  // แสดงแบบ stack ในจอเล็ก
                                    gap: isMobileView ? '8px' : '0'  // เพิ่มช่องว่างเล็กน้อยเมื่อแสดงแบบ column
                                }}>
                                    <input
                                        type="tel"
                                        style={{
                ...
                <div style={styles.descriptionsmall}>Share your favorites, comments and saved searches with others.</div>
                <div style={{ ...styles.searchPartnerContainer, width: isMobileView ? 'auto' : '300px', }}>
                    <div style={styles.searchPartnerButton} onClick={() => setsearchPartnerModalOpen(true)}>
                        <div style={{ ...styles.searchPartnerIconWrapper, width: isMobileView ? '24px' : '48px', height: isMobileView ? '24px' : '48px', }}>
                            <svg viewBox="0 0 24 24" style={{ ...styles.searchPartnerIcon, width: isMobileView ? '16px' : '24px', height: isMobileView ? '16px' : '24px', }}>
                                <path
                        ...
                        <span style={styles.searchPartnerText}>Add your search partner</span>
                    </div>
                </div>

                {/* โมดอลพาร์ทเนอร์ */}
                {searchPartnerModalOpen && (
                    <div style={{ ...styles.modalOverlay, }} onClick={() => setsearchPartnerModalOpen(false)}>
                        <div style={{
                            ...styles.modalContent,
                            minWidth: isMobileView && windowSize.width < 300 ? '250px' : '300px',
                        }} onClick={(e) => e.stopPropagation()}>

                            <div style={styles.headerpartner}>
                                <div style={styles.titleModal}>Add a member to your search</div>
                                <button style={styles.closeButton} onClick={() => setsearchPartnerModalOpen(false)}>×</button>
                            </div>
                            <div style={styles.subsectiontitle}>
                                Search partners can share favorites, saved searches, comments, tours, and offers.
                            </div>
                            ...
                            <input
                                ...
                                onChange={(e) => setPartnerEmails({ ...partnerEmails, email: e.target.value })}
                                required
                                style={styles.inputField}
                            />

                            <button style={styles.sendButton} onClick={handleAddPartner}>Send Invite</button>
                        </div>
                    </div>
                )}
                ...
                <div style={styles.description}>Sign in to Redfin with your social apps. We never post anything on your behalf.</div>
                <div style={{
                    ...styles.socialButtonsContainer,
                    flexDirection: isMobileView ? 'column' : 'row'
                }}>
                    <button
                        style={{ ...styles.socialButton, width: isMobileView ? '100%' : '250px' }}
                    ...
                    <div style={isMobileView ? styles.sectionMobile : styles.section}>
                        <div style={styles.contentWrapper}>
                            <div style={styles.subsectiontitle}>
                                Verify Your ID
                                <span style={styles.status}>
                                    {isVerifiedId ? 'Verified' : 'Not yet verified'}
                                </span>
                            </div>
                            <div style={styles.descriptionsmall}>
                ...
                <div style={styles.containerAllow}>
                    ...
                    <div style={styles.tooltipContainer}>
                        <div style={styles.infoIcon} onClick={toggleTooltip}>
                            <svg className="SvgIcon label-info" viewBox="0 0 24 24" style={{ width: "14px", height: "14px" }}>
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                    fill="#585858"
                        ...
                        {showTooltip && (
                            <div style={{
                                ...
                                <br />
                                This feature helps other buyers understand local trends and get a sense of what it takes
                                to win in different neighborhoods. If you make an offer with Redfin, we’ll publish
                                anonymized data on whether you won, how many competing offers you faced, how long the
                                property was on the market, how much you offered compared to the list price, and the
                                rough amount of the planned down-payment.
                            </div>
                        )}
                    </div>
                </div>
                <div style={styles.descriptionsmall}>Allow offer insights for offers that you submit.</div>

                {/* ส่วนของการลบบัญชี */}
                <div style={styles.sectiontitle}>Close Account</div>
                <div style={styles.descriptionsmall}>This will remove your login information from our system and you will not be able to login again. It cannot be undone.</div>
                <button style={{ ...styles.deleteButton, width: isMobileView ? '100%' : '250px' }} onClick={() => setdeleteAccountModalOpen(true)}>
                    Delete Your Account
                </button>

                {/* โมดอลลบบัญชี */}
                {deleteAccountModalOpen && (
                    <div style={styles.modalOverlay} onClick={() => setdeleteAccountModalOpen(false)}>
                        <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>

                            <div style={styles.headerpartner}>
                                <div style={styles.titleModal}>Delete Account</div>
                                <button style={styles.closeButton} onClick={() => setdeleteAccountModalOpen(false)}>×</button>
                            </div>
                            <div style={styles.subsectiontitle}>
                                Are you sure you want to delete your account? This cannot be undone.
                            </div>
                            <div style={styles.buttonContainer}>
                                <button style={styles.whiteButton} onClick={() => setdeleteAccountModalOpen(false)}>Cancel</button>
                                <button
