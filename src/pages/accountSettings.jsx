  ...
  return (
    <>
      ...
      <div style={styles.wrapper}>
        ...
        <div style={styles.container}>
          ...
          <div style={styles.profileSection}>
            ...
            <div style={styles.photoActions}>
              <a href="#" style={styles.photoLink}>Use Google Photo</a>
              <a href="#" style={styles.photoLink}>Change Photo</a>
              <a href="#" style={styles.photoLink}>Remove</a>
            </div>
          </div>
        ...
        <div style={styles.descriptionsmall}>Demonstrates your ability to obtain a mortgage for the amount in the offer.</div>

        <div style={styles.subsectiontitle}>Verify Your ID</div>
        <div style={styles.descriptionsmall}>To ensure the safety of our agents, we need you to verify your identity before we can take you on a home tour.</div>
