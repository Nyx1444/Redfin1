    ...
    return (
        <>
            ...
            <div style={NavStyles.navbar}>
                <button onClick={() => navigate('/test')} style={NavStyles.backButton} aria-label="Go back to search">
                    <BackIcon />
                    <span>Search</span>
                </button>
                ...
                <div style={NavStyles.navLinks}>
                    {tabs.map((tab, index) => (
                        ...
                        >
                            ...
                            {tab === activeTab && <div style={NavStyles.activeIndicator}></div>}
                        </div>
                    ))}
                </div>
            ...
            {/* ส่วนแสดงภาพ*/}
            <div ref={photoRef} data-section="Photo" style={{ scrollMarginTop: "60px" }}>
                <PropertyGallery />
            </div>

            <div style={{ display: "flex", justifyContent: "center", alignItems: "flex-start", gap: "30px", marginTop: "20px" }}>
                {/* Left section with OverviewCard and PropertyDetailsCard */}
                <div style={{ display: "flex", flexDirection: "column", flex: "1", maxWidth: "900px" }}>
                    <div ref={overviewRef} data-section="Overview" style={{ scrollMarginTop: "60px" }}>
                        <OverviewCard />
                    </div>

                    <div ref={detailsRef} data-section="Property details" style={{ scrollMarginTop: "60px" }}>
                        <PropertyDetailsCard />
                    </div>
                </div>
    ...
    return (
        <div style={GalleryStyles.container}>
            <div style={GalleryStyles.mainImageContainer}>
                <img src={images[0]} alt="Main Property" style={GalleryStyles.mainImage} />
            </div>
            <div style={GalleryStyles.subImagesContainer}>
                {images.slice(1, 7).map((image, index) => (
                    <div key={index} style={GalleryStyles.subImageWrapper}>
                        <img src={image} alt={`Sub ${index + 1}`} style={GalleryStyles.subImage} />
...
const OverviewCard = () => {
    ...
    // ดึงค่า `status` 
    const status = Array.isArray(property.status) ? property.status[0] : property.status;
    const cleanedStatus = status?.toString().trim().toLowerCase();

    // คำนวณราคา Price per Sq.Ft.
    const pricePerSqFt = property.details.sqft ? (property.price / property.details.sqft).toFixed(0) : "-";

    // ฟังก์ชันแปลงวันที่ Listed Date
    const formattedDate = new Date(property.listedDate).toLocaleDateString("en-US", {
        year: "numeric",
        month: "long",
        day: "numeric"
    });
    ...
    // คำที่ต้องการไฮไลต์
    const highlightWords = ["Welcome", "lakefront", "fitness center", "bike storage", "laundry center", "vintage courtyard building", "Montrose Beach"];
    ...
    const highlightText = (text) => {
        ...
        return text.split(regex).map((part, index) =>
            highlightWords.some(word => word.toLowerCase() === part.toLowerCase()) ? (
                <span key={index} style={{ fontWeight: "bold", color: "#15727A" }}>{part}</span>
            ) : (
                part
            )
        );
        ...
        switch (normalizedType) {
            ...
            case "house":
                return (
                    <svg viewBox="0 0 24 24" style={OverviewCardStyles.icontype}>
                        <path
                            d="M11.336 3.253a1 1 0 011.328 0l9 8a1 1 0 01-1.328 1.494L20 12.45V19a2 2 0 01-2 2H6a2 2 0 01-2-2v-6.55l-.336.297a1 1 0 01-1.328-1.494l9-8zM6 10.67V19h3v-5a1 1 0 011-1h4a1 1 0 011 1v5h3v-8.329l-6-5.333-6 5.333zM13 19v-4h-2v4h2z">
                        </path>
                    </svg>
                );
            case "townhouse":
                return (
                    <svg viewBox="0 0 24 24" style={OverviewCardStyles.icontype}>
                        <path d="M9 10a1 1 0 11-2 0 1 1 0 012 0zM9 14a1 1 0 11-2 0 1 1 0 012 0zM16 11a1 1 0 100-2 1 1 0 000 2zM16 15a1 1 0 100-2 1 1 0 000 2z">
                        </path>
                        <path
                            d="M8.017 2a1 1 0 01.764.375L12 6.4l3.22-4.024a1 1 0 011.54-.026l6 7a1 1 0 01-1.52 1.302L21 10.37V20a2 2 0 01-2 2H5a2 2 0 01-2-2v-9.63l-.24.28a1 1 0 01-1.52-1.3l6-7A1 1 0 018.018 2zM5 8.037V20h2v-2a1 1 0 112 0v2h2V8.35L7.973 4.569 5 8.037zm8 .314V20h2v-2a1 1 0 112 0v2h2V8.037l-2.973-3.47L13 8.352z">
                        </path>
                    </svg>
                );
            case "land":
            ...
            case "mobile":
                return (
                    <svg viewBox="0 0 24 24" style={OverviewCardStyles.icontype}>
                        <path d="M16.5 10a1.5 1.5 0 100 3 1.5 1.5 0 000-3z">
                        </path>
            ...
            case "multi-family":
                return (
                    <svg viewBox="0 0 24 24" style={OverviewCardStyles.icontype}>
                        <path d="M16 10a1 1 0 100 2 1 1 0 000-2zM15 15a1 1 0 112 0 1 1 0 01-2 0zM12 10a1 1 0 100 2 1 1 0 000-2zM7 11a1 1 0 112 0 1 1 0 01-2 0zM16 6a1 1 0 100 2 1 1 0 000-2zM11 7a1 1 0 112 0 1 1 0 01-2 0zM8 6a1 1 0 100 2 1 1 0 000-2z">
                        </path>
                        <path fill-rule="evenodd"
                            clip-rule="evenodd"
            ...
            case "other":
                return (
                    <svg viewBox="0 0 24 24" style={OverviewCardStyles.icontype}>
                        <path d="M9 11v-1a1 1 0 112 0v1a1 1 0 11-2 0zM13 10v1a1 1 0 102 0v-1a1 1 0 10-2 0z">
                        </path>
                        <path fill-rule="evenodd"
                            clip-rule="evenodd"
            ...
            <div style={OverviewCardStyles.propertyInfo}>
                <div style={OverviewCardStyles.statusRow}>
                    <span style={{
                        ...
                        backgroundColor: cleanedStatus === "sold" ? "red" :
                            cleanedStatus === "under contract" ? "#FF5F15" :
                                "green"
                    }}></span>
                    <span style={OverviewCardStyles.status}>
                        {cleanedStatus === "sold" ? "SOLD" : <>FOR SALE - <span style={OverviewCardStyles.active}>{status.toUpperCase()}</span></>}
                    </span>
                </div>
                <div style={OverviewCardStyles.addressContainer}>
                    <h2>
                        <span style={OverviewCardStyles.addressStreet}>{property.address.street},</span>{" "}
                ...
                <div style={OverviewCardStyles.propertyInfoContainer}>
                    <div style={OverviewCardStyles.priceSection}>
                        <p style={OverviewCardStyles.price}>${property.price.toLocaleString()}</p>
                        <p style={OverviewCardStyles.listedDate}>Listed on {formattedDate}</p>
                    </div>
                    <div style={OverviewCardStyles.detailSection}>
                        <strong style={OverviewCardStyles.detailValue}>{property.details.beds}</strong>
                        <span style={OverviewCardStyles.detailLabel}>Beds</span>
                    </div>
                    <div style={OverviewCardStyles.detailSection}>
                        <strong style={OverviewCardStyles.detailValue}>{property.details.baths}</strong>
                        <span style={OverviewCardStyles.detailLabel}>Baths</span>
                    </div>
                    <div style={OverviewCardStyles.detailSection}>
                        <strong style={OverviewCardStyles.detailValue}>{property.details.sqft || "—"}</strong>
                    ...
                    >
                        {showFullDescription ? (
                            <>
                                Show less
                                <svg
                                    style={{ ...OverviewCardStyles.showMoreIcon, ...(showFullDescription && OverviewCardStyles.rotated) }}
                                    viewBox="0 0 13 12"
                                >
                            ...
                            <>
                                Show more
                                <svg style={OverviewCardStyles.showMoreIcon} viewBox="0 0 13 12">
                                    <path d="M11.207 3.293a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L6.5 6.586l3.293-3.293a1 1 0 011.414 0z"></path>
                                </svg>
                            </>
                        )}
            ...
            <div style={OverviewCardStyles.detailsGrid}>
                ...
                {property.propertyType && (
                    <div style={OverviewCardStyles.detailIconItem}>
                        <span >
                            {renderPropertyIcon(property.propertyType)}
                        </span>
                        <div>
                            ...
                            </div>                            <div style={OverviewCardStyles.detailIconLabel}>Property Type</div>
                        </div>
                    </div>
                ...
                {property.yearBuilt && (
                    <div style={OverviewCardStyles.detailIconItem}>
                        ...
                        <div>
                            <div style={OverviewCardStyles.detailIconText}>{property.yearBuilt}</div>
                ...
                {pricePerSqFt && (
                    <div style={OverviewCardStyles.detailIconItem}>
                        ...
                        <div>
                            <div style={OverviewCardStyles.detailIconText}>${pricePerSqFt}</div>
                ...
                {property.hoaDues && (
                    <div style={OverviewCardStyles.detailIconItem}>
                        ...
                        <div>
                            <div style={OverviewCardStyles.detailIconText}>${property.hoaDues}/mo</div>
                ...
                {property.details.parking && (
                    <div style={OverviewCardStyles.detailIconItem}>
                        ...
                        <div>
                            <div style={OverviewCardStyles.detailIconText}>{property.details.parking}</div>
...
const ArrowUpIcon = () => (
    <svg viewBox="0 0 24 24" width="20" height="20" style={{ transform: 'rotate(270deg)' }}>
...
const PropertyDetailsCard = () => {
    ...
    return (
        <div style={PropertyDetailsStyles.card}>
            <h2 style={PropertyDetailsStyles.title}>Property Details for {property.address.street}</h2>

            {/* Parking */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('parking')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 24 24" width="24" height="24" style={{ marginRight: '8px' }}>
                            <path fillRule="evenodd" clipRule="evenodd" d="M11.336 3.253a1 1 0 011.328 0l9 8a1 1 0 01-1.328 1.494L20 12.45V19a2 2 0 01-2 2H6a2 2 0 01-2-2v-6.55l-.336.297a1 1 0 01-1.328-1.494l9-8zM6 10.67V19h2v-7a1 1 0 011-1h6a1 1 0 011 1v7h2v-8.329l-6-5.333-6 5.333zM14 19v-2h-4v2h4zm-4-4h4v-2h-4v2z"></path>
                        </svg>
                        <span>Parking</span>
                    </div>
                    <span>
                ...
                {expandedSections.parking && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Parking Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`# of Garage Spaces: ${property.parking.garage}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`# of Parking (Total): ${property.parking.total}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Parking On-Site: Yes`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Interior */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('interior')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 24 24" width="24" height="24" style={{ marginRight: '8px' }}>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12 4a5 5 0 00-2.5 9.332 1 1 0 01.5.865V16h4v-1.803a1 1 0 01.5-.865A5 5 0 0012 4zM5 9a7 7 0 1111 5.745V16a2 2 0 01-2 2h-4a2 2 0 01-2-2v-1.255A6.993 6.993 0 015 9z"></path><path d="M9 21a1 1 0 011-1h4a1 1 0 110 2h-4a1 1 0 01-1-1z"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M1.134 15.274a1 1 0 01.366-1.366l1.34-.774a1 1 0 111 1.732l-1.34.774a1 1 0 01-1.366-.367zM19.794 4.5a1 1 0 01.366-1.366l1.34-.774a1 1 0 111 1.733l-1.34.773a1 1 0 01-1.366-.366zM1.134 2.727A1 1 0 012.5 2.36l1.34.774a1 1 0 01-1 1.732L1.5 4.093a1 1 0 01-.366-1.366zM19.794 13.5a1 1 0 011.366-.366l1.34.774a1 1 0 11-1 1.732l-1.34-.774a1 1 0 01-.366-1.366z"></path>
                        </svg>
                        <span>Interior</span>
                    </div>
                    <span>
                ...
                {expandedSections.interior && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Bathroom Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`# of Baths (Full): ${property.interior.baths}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Exterior  */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('exterior')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 25 24" width="24" height="24" style={{ marginRight: '8px' }}>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.282 15.602v-4.139l-2.75-2.75a.917.917 0 111.296-1.296l1.454 1.453V7.417a.917.917 0 011.833 0v4.203l1.454-1.453a.917.917 0 111.296 1.296l-2.75 2.75v1.389a6.418 6.418 0 00-.917-12.769 6.417 6.417 0 00-.916 12.769zm0 1.848a8.251 8.251 0 111.833 0v4.633a.917.917 0 11-1.833 0V17.45z"></path>
                        </svg>
                        <span>Exterior</span>
                    </div>
                    <span>
                ...
                {expandedSections.exterior && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Building Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Living Area Source: ${property.exterior.livingArea}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Building Type: ${property.exterior.buildingType}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Financial  */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('financial')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 25 24" width="24" height="24" style={{ marginRight: '8px' }}>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.795 12a8 8 0 1116 0 8 8 0 01-16 0zm8-10c-5.523 0-10 4.477-10 10s4.477 10 10 10 10-4.477 10-10-4.477-10-10-10zm0 3.5a1 1 0 011 1v.671a3 3 0 01.985.58 1 1 0 01-1.324 1.499 1 1 0 10-.661 1.75 3 3 0 011 5.83v.67a1 1 0 11-2 0v-.671a3 3 0 01-.984-.58 1 1 0 111.323-1.499 1 1 0 10.661-1.75 3 3 0 01-1-5.83V6.5a1 1 0 011-1z"></path>
                        </svg>
                        <span>Financial</span>
                    </div>
                    <span>
                ...
                {expandedSections.financial && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        ...
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Tax Annual Amount: ${property.financial.taxAmount}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Tax Year: ${property.financial.taxYear}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Utilities  */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('utilities')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 24 24" width="24" height="24" style={{ marginRight: '8px' }}>
                            <path d="M8.5 8a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM12 6a1 1 0 011-1h3a1 1 0 110 2h-3a1 1 0 01-1-1z"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M17 14a5 5 0 10-10 0 5 5 0 0010 0zm-5-3a3 3 0 012.236 5H9.764A3 3 0 0112 11z"></path>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M6 2a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2H6zm0 2h12v16H6V4z"></path>
                        </svg>
                        <span>Utilities</span>
                    </div>
                    <span>
                ...
                {expandedSections.utilities && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Utility Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Water Source: ${property.utilities.waterSource}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Location */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('location')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 25 24" width="24" height="24" style={{ marginRight: '8px' }}>
                ...
                {expandedSections.location && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Homeowners Association Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Master Association Fee Frequency: ${property.location.associationFee}`}</li>
                        </ul>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>School Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Elementary School District: ${property.location.elementarySchoolDistrict}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Middle School District: ${property.location.middleSchoolDistrict}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`High School District: ${property.location.highSchoolDistrict}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`High School: ${property.location.highSchool}`}</li>
                        </ul>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Location Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Township: ${property.location.township}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Corporate Limits: ${property.location.corporateLimits}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Directions: ${property.location.directions}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Public Facts  */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('publicFacts')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 25 24" width="24" height="24" style={{ marginRight: '8px' }}>
                ...
                {expandedSections.publicFacts && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Beds: ${property.publicFacts.beds}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Baths: ${property.publicFacts.baths}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Finished Sq. Ft.: ${property.publicFacts.finishedSqFt}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Total Sq. Ft.: ${property.publicFacts.totalSqFt}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Stories: ${property.publicFacts.stories}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Lot Size: ${property.publicFacts.lotSize}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Style: ${property.publicFacts.style}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Year Built: ${property.publicFacts.yearBuilt}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`County: ${property.publicFacts.county}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`APN: ${property.publicFacts.apn}`}</li>
                        </ul>
                    </div>
                )}
            </div>
            ...
            {/* Other  */}
            <div style={PropertyDetailsStyles.section}>
                <div style={PropertyDetailsStyles.sectionHeader} onClick={() => toggleSection('other')}>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <svg viewBox="0 0 25 25" width="24" height="24" style={{ marginRight: '8px' }}>
                ...
                {expandedSections.other && (
                    <div style={PropertyDetailsStyles.sectionContent}>
                        <h4 style={PropertyDetailsStyles.sectionTitle}>Listing Information</h4>
                        <ul style={PropertyDetailsStyles.list}>
                            <li style={PropertyDetailsStyles.listItem}>{`Holds Earnest Money: ${property.other.earnestMoney}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Possession: ${property.other.possession}`}</li>
                            <li style={PropertyDetailsStyles.listItem}>{`Some Photos Virtually Staged?: ${property.other.photosStaged}`}</li>
                        </ul>
                    </div>
                )}
            </div>
...
const OverviewCardStyles = {
    ...
    propertyInfoContainer: {
        ...
        width: "100%",
        marginBottom: "1rem",
        fontFamily: "Inter, -apple-system, BlinkMacSystemFont, Roboto, Droid Sans, Helvetica, Arial, sans-serif", // เพิ่มฟอนต์เดียวกันใน container นี้
    },
    priceSection: {
        display: "flex",
        flexDirection: "column",
    ...
    return (
        <div style={ContactCardStyles.container}>
            ...
            <div style={ContactCardStyles.dateSelector}>
                ...
                {/* ปุ่มย้อนกลับ */}
                <button style={currentIndex > 0 ? ContactCardStyles.arrowButton : { ...ContactCardStyles.arrowButton, visibility: "hidden" }} onClick={handlePrev}>
                    <svg viewBox="0 0 25 24" width="16" height="16" style={{ transform: "rotate(180deg)" }}>
                        <path d="M9.99 18.707a1 1 0 010-1.414L15.285 12 9.99 6.707a1 1 0 111.414-1.414l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414 0z"></path>
                    </svg>
                </button>
                ...
                <div style={ContactCardStyles.dateButtonsContainer}>
                    {dateArray.slice(currentIndex, currentIndex + 3).map((date, index) => (
                        <button
                            key={index}
                            style={{
                                ...ContactCardStyles.dateButton,
                                ...(selectedDateIndex === index && ContactCardStyles.selectedDate),
                            }}
                            onClick={() => handleDateSelect(index)}
                        >
                            <div style={selectedDateIndex === index ? { ...ContactCardStyles.dayStyle, color: "#15727a" } : ContactCardStyles.dayStyle}>{date.day}</div>
                            <div style={selectedDateIndex === index ? { ...ContactCardStyles.dateStyle, color: "#15727a" } : ContactCardStyles.dateStyle}>{date.date}</div>
                            <div style={selectedDateIndex === index ? { ...ContactCardStyles.monthStyle, color: "#15727a" } : ContactCardStyles.monthStyle}>{date.month}</div>
                        </button>
                    ))}
                </div>

                {/* ปุ่มไปข้างหน้า */}
                <button style={currentIndex + 3 < dateArray.length ? ContactCardStyles.arrowButton : { ...ContactCardStyles.arrowButton, visibility: "hidden" }} onClick={handleNext}>
            ...
            <div style={ContactCardStyles.tourOptions}>
                <button
                    style={{
                        ...
                        ...(selectedTourOption === 'inPerson' && ContactCardStyles.selectedTourOption),
                    }}
                ...
                <button
                    style={{
                        ...
                        ...(selectedTourOption === 'videoChat' && ContactCardStyles.selectedTourOption),
                    }}
            ...
            <div style={ContactCardStyles.requestShowingContainer}>
                ...
                <div style={ContactCardStyles.requestDescription}>Tour for free, no strings attached</div>
            </div>
...
const ContactCardStyles = {
    container: {
        fontFamily: `"Inter", -apple-system, BlinkMacSystemFont, "Roboto", "Droid Sans", "Helvetica", "Arial", sans-serif`, padding: "20px",
