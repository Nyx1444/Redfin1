    ...
    return (
        <div style={styles.global}>
            ...
            <div style={styles.PageBody}>
                <div style={{ ...styles.Card, padding: isMobileView ? '24px 16px' : '32px' }}>
                    <h1 style={styles.title}>For agent safety, please verify your identity.</h1>
                    <p style={styles.subtitle}>
                        This information isn't shared with anyone and is only used to verify your identity.
                    </p>
