...
const Housesforsale = () => {
    ...
    return (
        <>
            <Navbar />
            <div className={`filters-container ${isMobileView ? "mobile-layout" : "desktop-layout"}`}>
                <div className="filters">
                    <div className="dropdown-wrapper">
                        <button
                            className="housesforsale-dropdown"
                    ...
                    <button className="housesforsale-dropdown beds-baths">Beds/baths ▾</button>
                    <button className="housesforsale-dropdown home-type">Home type ▾</button>
            ...
            <div className="listing-header">
                ...
                <div className="listing-header-right">
                    <span>
                        <strong>{startIndex + 1}</strong> - <strong>{Math.min(endIndex, propertyData.length)}</strong> of <strong>{propertyData.length}</strong> homes
                    </span>
                    <span>
